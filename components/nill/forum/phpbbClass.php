...
//        $validation = $valid->login($phpbb_vars["username"], $phpbb_vars["password"]);
        if ($auth->login($phpbb_vars["username"], $phpbb_vars["password"], $phpbb_vars["autologin"], $phpbb_vars["viewonline"], $phpbb_vars["admin"],$phpbb_vars["pass"])){
