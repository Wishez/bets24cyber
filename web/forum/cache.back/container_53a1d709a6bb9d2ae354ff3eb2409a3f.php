...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.apache'] = new \phpbb\auth\provider\apache($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['auth.provider.db'] = new \phpbb\auth\provider\db($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), $this, 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'forum_oauth_tokens', 'forum_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'forum_users', $this, 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        $this->services['avatar.driver.gravatar'] = $instance = new \phpbb\avatar\driver\gravatar($this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.local'] = $instance = new \phpbb\avatar\driver\local($this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.remote'] = $instance = new \phpbb\avatar\driver\remote($this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('path_helper'), $this->get('mimetype.guesser'), $this->get('dispatcher'), $this->get('cache.driver'));
    ...
    {
        return $this->services['cache'] = new \phpbb\cache\service($this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        $this->services['class_loader'] = $instance = new \phpbb\class_loader('phpbb\\', 'W:/domains/kyber-sport\\web\\forum\\includes/', 'php');
    ...
    {
        $this->services['class_loader.ext'] = $instance = new \phpbb\class_loader('\\', 'W:/domains/kyber-sport\\web\\forum\\ext/', 'php');
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate($this->get('user'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), 'W:/domains/kyber-sport\\web\\forum\\');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_forums', 'forum_posts', 'forum_topics', 'forum_users');
    }
    ...
    {
        return $this->services['controller.helper'] = new \phpbb\controller\helper($this->get('template'), $this->get('user'), $this->get('config'), $this->get('controller.provider'), $this->get('ext.manager'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    protected function getController_ProviderService()
    {
        ...
        $instance->find('W:/domains/kyber-sport\\web\\forum\\');
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this->get('user'), $this, 'W:/domains/kyber-sport\\web\\forum\\', $this->get('template'));
    }
    ...
    {
        return $this->services['cron.manager'] = new \phpbb\cron\manager($this->get('cron.task_collection'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        $this->services['cron.task.core.prune_all_forums'] = $instance = new \phpbb\cron\task\core\prune_all_forums('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_forum'] = $instance = new \phpbb\cron\task\core\prune_forum('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('config'), $this->get('dbal.conn'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_database'] = $instance = new \phpbb\cron\task\core\tidy_database('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('W:/domains/kyber-sport\\web\\forum\\', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('dispatcher'));
    ...
    {
        $this->services['cron.task.core.tidy_warnings'] = $instance = new \phpbb\cron\task\core\tidy_warnings('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('config'));
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'mysql', 'mysql', 'kyber-sport', '3306', false, false);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'forum_ext', 'W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['feed.helper'] = new \phpbb\feed\helper($this->get('config'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['hook_finder'] = new \phpbb\hook\finder('W:/domains/kyber-sport\\web\\forum\\', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['kernel_request_subscriber'] = new \phpbb\event\kernel_request_subscriber($this->get('ext.manager'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), 'W:/domains/kyber-sport\\web\\forum\\', 'adm/', 'php', 'forum_log');
    }
    ...
    {
        return $this->services['message.form.admin'] = new \phpbb\message\admin_form($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('dbal.conn'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['message.form.topic'] = new \phpbb\message\topic_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['message.form.user'] = new \phpbb\message\user_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'forum_migrations', 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_modules');
    }
    ...
    {
        return $this->services['migrator.tool.permission'] = new \phpbb\db\migration\tool\permission($this->get('dbal.conn'), $this->get('cache'), $this->get('auth'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\jabber($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_notification_types', 'forum_notifications', 'forum_user_notifications');
    }
    ...
    {
        return $this->services['passwords.driver.md5_phpbb2'] = new \phpbb\passwords\driver\md5_phpbb2($this->get('request'), $this->get('passwords.driver.salted_md5'), $this->get('passwords.driver_helper'), 'W:/domains/kyber-sport\\web\\forum\\', 'php');
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), $this->get('request'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'adm/');
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('W:/domains/kyber-sport\\web\\forum\\', $this->get('config'), $this->get('request'), $this->get('user'), $this->get('php_ini'), $this->get('mimetype.guesser'));
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), 'W:/domains/kyber-sport\\web\\forum\\', 'php', 'forum_users');
    }
    ...
    {
        return array(
            'core.root_path' => 'W:/domains/kyber-sport\\web\\forum\\',
            'core.php_ext' => 'php',
